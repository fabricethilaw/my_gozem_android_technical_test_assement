 ...
 * <p>
 * With app we are showing how to use a long-running service for location updates. When an activity is
...
public class LocationUpdatesService extends Service {
    ...
    private Notification getNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(R.mipmap.ic_launcher, getString(R.string.launch_activity, getString(R.string.app_name)),
